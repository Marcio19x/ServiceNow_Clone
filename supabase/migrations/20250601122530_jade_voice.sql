-- Seed Users with hashed passwords (password is 'password123' for all users)
INSERT INTO users (id, email, password)
SELECT 
    uuid::uuid, email, password
FROM (
    VALUES 
        ('d7bed82c-5f89-4d49-9fde-10c35d304783', 'admin@example.com', '$2a$10$xLVGkigNwU0ebP1XtV1YO.ZFwZaxR79uRzpH3AZE.CbefKQjpXc8m'),
        ('b9c9c8d2-efb9-4a77-a9f3-c53c1e5f3c81', 'agent1@example.com', '$2a$10$xLVGkigNwU0ebP1XtV1YO.ZFwZaxR79uRzpH3AZE.CbefKQjpXc8m'),
        ('f1c5b83a-99c8-4d29-b89d-71a4d740f004', 'agent2@example.com', '$2a$10$xLVGkigNwU0ebP1XtV1YO.ZFwZaxR79uRzpH3AZE.CbefKQjpXc8m'),
        ('e4a79e67-d751-4c47-93c7-2c3c60c938d9', 'user1@example.com', '$2a$10$xLVGkigNwU0ebP1XtV1YO.ZFwZaxR79uRzpH3AZE.CbefKQjpXc8m'),
        ('a2b4c6d8-e0f2-4a6c-8e0a-2c4e6f8a0c2e', 'user2@example.com', '$2a$10$xLVGkigNwU0ebP1XtV1YO.ZFwZaxR79uRzpH3AZE.CbefKQjpXc8m')
